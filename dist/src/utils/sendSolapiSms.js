...
exports.sendSolapiSms = sendSolapiSms;
const axios_1 = __importDefault(require("axios"));
const crypto_1 = __importDefault(require("crypto"));
const makeHmacSignature_1 = require("./makeHmacSignature");
/* ── Solapi 환경변수 ────────────────────────────── */
...
let forceStub = false;
async function sendSolapiSms(to, text, stub = process.env.NODE_ENV !== 'production' // 기본: 개발환경이면 stub
) {
    ...
    const salt = crypto_1.default.randomUUID();
    const signature = (0, makeHmacSignature_1.makeHmacSignature)(SOLAPI_SECRET, date, salt);
    try {
        await axios_1.default.post(SOLAPI_URL, {
